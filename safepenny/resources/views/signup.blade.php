        ...
        <section class="__sp-cen-block">
            ...
            <div class="__sp-boxsigin">
                ...
                <form action="" method="post">
                    ...
                    <input class="__b12" type="password" name="retype_password" placeholder="Re-Password"/>
                    <input class="__b12" type="text" name="phone" placeholder="Phone-no"/>
                    <span>
                        <input class="__b13" type="checkbox" name="remember"/> Remember Me
                    </span>

                    <button type="submit" name="S_button" class="button-success pure-button __sp-seconday">SIGNUP</button>
                </form>
                    <?php 
                        if(isset($_POST['']))
