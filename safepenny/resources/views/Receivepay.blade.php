...
@section('css')
    ...
    <link href="{{ asset('custom/css/Receivepay.css') }}" rel="stylesheet" type="text/css">
        ...
        <div class="pure-g __sp-navCon">
            <div class="pure-u-1-5 __sp-leftNav">
                <div id="__sp-leftNavLinksCon">
                    ...
                    <a href="#"><i class="fa fa-flag"></i> <span data-status="active">Receive Pay</span></a>
                                    ...
                                    <div class="__form44">
                                        <form class="pure-form pure-form-aligned" id="__form">
                                            <fieldset>
                                                ...
                                                <input id="__amount" type="text" placeholder="10,000 naira">
                                                 <button class="__sp-botton1" {{ url('#')}}>Confirm payment</button>
