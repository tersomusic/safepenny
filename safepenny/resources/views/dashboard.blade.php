        ...
        <div class="pure-g __sp-navCon">
            <div class="pure-u-1-5 __sp-leftNav">
                <div id="__sp-leftNavLinksCon">
                    <a href=" {{ url('dashboard') }}" data-status="active"><i class="fa fa-home"></i> <span>Dashboard</span></a>
                    ...
                    <a href="{{ url('dashboard/Referral') }}"><i class="fa fa-database"></i> <span>Referrals Earnings</span></a>
                </div>
            </div>
        </div>
    <body>
            <div class="pure-u-4-5 __sp-rightNav">
                ...
                <div id="__sp-gloActInf-3" class="pure-g">
                    <div class="pure-u-12-24">
                        <div class="l-xamc" style="padding-right:5%;">
                            <div class="block-side1 block-ash" id="__legsl2">
                                <a href="#" class="__arss"><i class="fa fa-rss"></i><span class="__text1">Recent Activities</span> </a>
                            </div>
                            <div class="block-side1"></div>
                            <div class="block-side1 block-ash"></div>
                            <div class="block-side1"></div>
                            <div class="block-side1 block-ash"></div>
                            <div class="block-side1"></div>
                    ...
                    <div class="pure-u-12-24">
                        <div class="l-xamc" >
                            <div class="block-side1 block-ash" id="__legsl2">
                                <a href="#" class="__arss"><i class="fa fa-info"></i><span class="__text1">Latest Site News</span> </a>
                            </div>
                            <div class="block-side1"></div>
                            <div class="block-side1 block-ash"></div>
                            <div class="block-side1"></div>
